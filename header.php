<head>
	...
	<div class="jumbotron" style="margin-bottom:0px;height:100%">
	  <div class="container" >
	    ...
	    <h1 id="title_h1" style="margin-bottom:0px;padding-bottom:0px;" align="center"><a href="../"><span style="color:#ea2f10">Can-VD</span>: The <span style="color:#ea2f10">Can</span>cer <span style="color:#ea2f10">V</span>ariants <span style="color:#ea2f10">D</span>atabase</a></h1>
    <p id="top_btns" style="margin-bottom:25px;" align="center">
